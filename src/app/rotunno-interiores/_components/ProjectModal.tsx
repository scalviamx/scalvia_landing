        ...
        <div className="flex items-start justify-between gap-4 border-b border-charcoal/10 p-5 sm:p-6">
          <div>
            <div className="flex items-center gap-2">
              ...
              {isConceptual && (
                <span className="rounded border border-oak/40 bg-linen px-2 py-0.5 text-xs font-medium text-walnut">
                  Diseño conceptual
                </span>
              )}
            </div>
          ...
          <button
            ...
            className="rounded-md border border-charcoal/15 p-2 text-charcoal transition hover:bg-charcoal hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-walnut"
            onClick={onClose}
          >
            <X size={18} />
          </button>
